...
- (void)setupCell{
    ...
    self.recordImageView = [[UIImageView alloc] initWithFrame:CGRectMake(15, self.titleLabel.frame.origin.y + self.titleLabel.frame.size.height + 10, 100, 40)];
    self.recordImageView.backgroundColor = [UIColor redColor];
    [self.contentView addSubview:self.recordImageView];
    
    self.subtitleImageView = [[UIImageView alloc] initWithFrame:CGRectMake(15, self.recordImageView.frame.origin.y + self.recordImageView.frame.size.height + 10, 16, 16)];
